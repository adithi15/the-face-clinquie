...
function Navbar() {
  ...
  const navLinks = [
    ...
    { name: "OurService", href: "#about" },
    { name: "Our Experts", href: "#classes" },
    { name: "Get Consultation", href: "#pricing" },
  ];
  ...
  return (
   ...
   {navLinks.map((link) => (
          ...
          {/* <a
            href="#joinnow"
            className="ml-4 px-5 py-2 rounded-full text-sm font-medium text-black bg-white shadow-[0_4px_20px_rgba(255,255,255,0.2)] hover:bg-white/90 transition-all duration-300"
          >
            Join Now
          </a> */}
